<%-- 
    Document   : buyer
    Created on : Jan 9, 2021, 2:44:45 PM
    Author     : DELL
--%>
    ...
    <body>
        ...
        <center>
            ...
            <form action="process" method="POST">
                ...
                <input type="submit" value="Best Seller" name="btAction"/>
                <br/>
                <p><font color="grey">-Select and buy food now-</font></p>
        ...
        <section>
            ...
            <c:forEach var="f" items="${food}">
                ...
                <div class="img">
                    ...
                    <br/>
                    ${f.fprice }VNĐ <br/>
                    <a href="addtocart?id=${f.fid}">Add to Cart</a>
                </div>
                </c:if>    
            </c:forEach>
        </section>
        ...
        <c:if test="${not empty best}">
            <center>
                ...
                <div class="bs">
                    ...
                    <br/>
                    ${best.fprice }VNĐ <br/>
                    <a href="addtocart?id=${best.fid}">Add to Cart</a>
                </div>
            </center>
        </c:if>
    </body>
